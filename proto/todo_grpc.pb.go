...
type TodoServiceClient interface {
	AddTask(ctx context.Context, in *TaskRequest, opts ...grpc.CallOption) (*Empty, error)
	GetTasks(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*TaskResponse, error)
...
func (c *todoServiceClient) AddTask(ctx context.Context, in *TaskRequest, opts ...grpc.CallOption) (*Empty, error) {
...
func (c *todoServiceClient) GetTasks(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*TaskResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *todoServiceClient) CompleteTask(ctx context.Context, in *CompleteTaskRequest, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
...
type TodoServiceServer interface {
	AddTask(context.Context, *TaskRequest) (*Empty, error)
	GetTasks(context.Context, *Empty) (*TaskResponse, error)
...
func (UnimplementedTodoServiceServer) AddTask(context.Context, *TaskRequest) (*Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddTask not implemented")
}
func (UnimplementedTodoServiceServer) GetTasks(context.Context, *Empty) (*TaskResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetTasks not implemented")
}
func (UnimplementedTodoServiceServer) CompleteTask(context.Context, *CompleteTaskRequest) (*Empty, error) {
